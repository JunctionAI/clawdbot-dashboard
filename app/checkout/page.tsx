        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -10 }}
              className="max-w-2xl mx-auto mb-6 p-4 bg-red-900/30 border border-red-500/50 rounded-xl"
            >
              <div className="flex items-center justify-center gap-4">
                ...
                <button
                  ...
                  className="ml-2 px-3 py-1 text-sm font-medium text-red-400 border border-red-500/50 rounded-lg hover:bg-red-500/10 transition-colors"
                >
                  Try Again
                </button>
              </div>
