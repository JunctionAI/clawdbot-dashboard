...
export function ConfirmModal({
  ...
  const icons = {
    danger: (
      <div className="mx-auto flex items-center justify-center w-12 h-12 rounded-full bg-red-900/50 mb-4">
    ...
    warning: (
      <div className="mx-auto flex items-center justify-center w-12 h-12 rounded-full bg-yellow-900/50 mb-4">
    ...
    info: (
      <div className="mx-auto flex items-center justify-center w-12 h-12 rounded-full bg-purple-900/50 mb-4">
      ...
      <div className="text-center">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className={`px-4 py-2 text-sm font-medium text-white rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 ${variantStyles[variant]} disabled:opacity-50`}
          >
            {isLoading ? (
